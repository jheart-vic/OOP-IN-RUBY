require './creations/create_books'
require './creations/create_people'
require './creations/create_students'
require './creations/create_teacher'
require './creations/create_rentals'
require './stores/bookstore'
require './stores/rentalstore'
require './stores/peoplestore'
